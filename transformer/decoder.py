...
class Decoder(nn.Module):
    ...
    def forward(self, padded_input, encoder_padded_outputs,
        ...
        slf_attn_mask = (slf_attn_mask_keypad + slf_attn_mask_subseq).gt(0) #.type_as(slf_attn_mask_subseq)
    ...
    def recognize_beam(self, encoder_outputs, char_list, beam_size, nbest, decode_max_len):
